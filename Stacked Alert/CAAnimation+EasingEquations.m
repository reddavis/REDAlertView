...
{
    CAAnimation *animation = [self animationWithKeyPath:keyPath duration:duration from:[[layer valueForKeyPath:keyPath] floatValue] to:endValue easingFunction:easingFunction completionBlock:block];
...
{
    CAAnimation *animation = [self animationWithKeyPath:keyPath duration:duration from:startValue to:endValue easingFunction:easingFunction completionBlock:block];
    [layer addAnimation:animation forKey:nil];
}
...
- (void)setCompletionBlock:(CAAnimationCompletionBlock)completionBlock
{
    ...
    objc_setAssociatedObject(self, &kCompletionBlockKey, completionBlock, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
